...
export default function RegisterPage() {
    ...
    useEffect(() => {
        ...
        returnUrl ? navigate(returnUrl) : navigate('/'); // user is logged in so we navigate to returnUrl if not null, else navigate to homepage
    }, [user]);
    ...
    return (
        <div className={classes.container}>
            <div className={classes.details}>
                ...
                <form onSubmit={handleSubmit(submit)} noValidate /* noValidate because we want to use our own validation not default one */ >
                    <Input
                        type="text"
                        label="Name"
                        {...register('name', {
