...
export default function FoodPage() {
    ...
    // for getting :id path from AppRoutes to give us /food/:id path
                ...
                <div className={classes.header} /* displays food name and if it's favorited */ >
                    ...
                    <div className={classes.tags}>
                        {food.tags && ( // check if food.tags has a value, then -
                            <Tags // tags component's tag(s), an array of strings, which are just s are converted to an object with corresponding name
