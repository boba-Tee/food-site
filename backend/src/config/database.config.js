...
const PASSWORD_HASH_SALT_ROUNDS = 10; // # of times bcryptjs will hash our data

// this will make Mongoose use the schema of our models strictly, adds a layer of security
...
async function seedFoods() {
    ...
    for (const food of sample_foods) {
        // mistake from frontend side, means if we have foods outside local machine, we will get errors
